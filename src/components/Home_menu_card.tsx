...
const ScrollableMenuCards = forwardRef<
  ScrollableMenuRef,
  ScrollableMenuCardsProps
>(
  (
    { menuItems, onAddToCart, onReadMore, onToggleFavorite, onScrollEndChange },
    ref
  ) => {
            ...
            >
              ...
              <div className="mt-[-12px] z-10 relative bg-black rounded-[12px] px-[16px] pt-4">
                ...
                <div className="flex mt-1 items-center">
                  <span className="text-normal4 text-primary font-bold">
                    £ {item.price}
                  </span>
