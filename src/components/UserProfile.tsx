...
import PhoneVerificationForm from "./Auth/PhoneVerification";
                      ...
                      <div className="flex flex-row items-center gap-[10px]">
                        ...
                        {profile.phoneVerified ? (
                          <svg height="20" width="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill="#1DA1F2" d="M10,0C4.477,0,0,4.477,0,10s4.477,10,10,10s10-4.477,10-10S15.523,0,10,0z M8.293,14.293l-3.586-3.586l1.414-1.414L8.293,11.465l5.879-5.879l1.414,1.414L8.293,14.293z" />
                          </svg>
                        ) : (
                          <button onClick={() => {SetPhoneVerification(true)}} className="text-xs text-primary underline hover:text-primary-dark"> verify now </button>
                        )}
                      </div>
                    </div>  
                  </div>
...
// Main User Profile Component (including Profile Button and Modals)
