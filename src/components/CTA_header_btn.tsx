...
export const AnimatedCTAButton_LoggedOut: React.FC<AnimatedCTAButtonProps> = ({
  onSignInClick,
  handelOrderNowClick,
}) => {
  ...
  return (
    <div className="flex justify-center items-center w-[251px] h-[41px]">
      <div className="relative w-full max-w-lg h-full">
        {/* Left Button */}
        <motion.button
          className="absolute h-full rounded-l-lg overflow-hidden flex items-center border bg-black border-primary-dark"
          style={{
            originX: 1,
        ...
        {/* Right Button */}
        <motion.button
          className="absolute h-full rounded-r-lg overflow-hidden flex items-center bg-primary border border-primary-dark"
          style={{
            originX: 0,
        ...
        >
          <div className="flex items-center justify-between w-full">
            <motion.div
              className="overflow-hidden text-nowrap text-normal2 font-bold text-white flex-1 mx-auto"
              animate={{
...
export const AnimatedCTAButton_LoggedIn = ({
  handelOrderNowClick,
  OnLoginRequired,
}: {
  handelOrderNowClick?: () => void;
  ...
  return (
    <div className="flex justify-center items-center w-[471px] h-[41px]">
      <div className="relative w-full h-full flex flex-row">
        {/* Left Buttons */}
        <div
          className="flex flex-row items-center right-[50px] sm:right-[169px]"
          style={{
            position: "absolute",
          }}
        >
        ...
        {/* Right Button */}
        <div
          className="absolute h-full rounded-lg overflow-hidden flex items-center bg-primary border border-primary-dark w-fit sm:w-[157px]"
          style={{ right: "0%" }}
        >
          <div className="flex items-center justify-between w-full ">
            <div
